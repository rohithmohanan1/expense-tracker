...
const Profile = () => {
  ...
  const accoundOptions: accountOptionType[] = [
    {
      title: "Edit Profile",
      icon: (
        <Icons.User 
  ...
  const hanldePress = (item: accountOptionType) => {
